<template>
   <div class="card-deck">
          <div class="card text-center shadow-lg p-3 mb-5 bg-white rounded col-lg mb-3">
            <img v-if="book.isbn" v-bind:src="'http://covers.openlibrary.org/b/isbn/' + book.isbn + '-M.jpg'" class="image card-img-top" alt="" />
            <div class="card-body">
